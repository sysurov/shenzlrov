...
public class CameraOperate_Add
  implements Function
{
  ...
  public CameraOperate_Add(String paramString, int paramInt1, int paramInt2)
  {
    ...
    for (;;)
    {
      ...
      this.Scale[i] = ((paramInt2 - paramInt1) / 100);
      if (this.Scale[i] <= 0) {
        this.Scale[i] = 1;
      }
      i += 1;
  ...
  public CameraOperate_Add(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
    this.Index = new String[] { paramString };
    this.minNum = new int[] { paramInt1 };
    this.maxNum = new int[] { paramInt2 };
  ...
  public CameraOperate_Add(String[] paramArrayOfString, int[] paramArrayOfInt1, int[] paramArrayOfInt2)
  {
    ...
    for (;;)
    {
      ...
      this.Scale[i] = ((paramArrayOfInt2[i] - paramArrayOfInt1[i]) / 100);
      if (this.Scale[i] <= 0) {
        this.Scale[i] = 1;
      }
      i += 1;
  ...
  public CameraOperate_Add(String[] paramArrayOfString, int[] paramArrayOfInt1, int[] paramArrayOfInt2, int[] paramArrayOfInt3)
  {
    this.Index = paramArrayOfString;
    this.minNum = paramArrayOfInt1;
    this.maxNum = paramArrayOfInt2;
  ...
  public boolean FunctionStart(int paramInt1, int paramInt2)
  {
    ...
    if (((Integer)localObject2).intValue() + this.Scale[paramInt1] >= this.maxNum[paramInt1]) {
      localObject1 = Integer.valueOf(this.maxNum[paramInt1]);
    }
    localObject2 = this.Index[paramInt1];
    if (((Integer)localObject1).intValue() >= this.maxNum[paramInt1]) {}
    for (paramInt2 = this.maxNum[paramInt1];; paramInt2 = ((Integer)localObject1).intValue() + this.Scale[paramInt1])
    {
...
/* Location:              /home/sunny/dex2jar-2.0/classes-dex2jar.jar!/com/deepinfar/Task/CameraTask/CameraOperate_Add.class
