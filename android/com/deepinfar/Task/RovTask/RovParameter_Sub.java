  ...
  implements Function
{
  ...
  public RovParameter_Sub(String paramString, int paramInt1, int paramInt2, int paramInt3)
  {
  ...
  public RovParameter_Sub(String paramString, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    this.TAG = paramString;
    this.TimeNum = paramInt1;
  ...
  public boolean FunctionStart(int paramInt1, int paramInt2)
  {
    if ((this.scale > 0) && (paramInt2 % this.TimeNum == 0))
    {
      ...
      str = this.TAG;
      if (paramInt1 - this.scale <= this.minParameter) {
        paramInt1 = this.minParameter;
      }
      for (;;)
      {
        localRovData.UpdataData(str, Integer.valueOf(paramInt1));
        return true;
        paramInt1 -= this.scale;
      }
    }
    ...
    String str = this.TAG;
    if (i - paramInt1 <= this.minParameter) {}
    for (paramInt1 = this.minParameter;; paramInt1 = i - paramInt1)
    {
      localRovData.UpdataData(str, Integer.valueOf(paramInt1));
      break;
    }
...
/* Location:              /home/sunny/dex2jar-2.0/classes-dex2jar.jar!/com/deepinfar/Task/RovTask/RovParameter_Sub.class
